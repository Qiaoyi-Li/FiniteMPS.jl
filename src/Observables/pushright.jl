...
function _pushright(El::BilayerLeftTensor{2, 2}, A::AdjointMPSTensor{4}, ::IdentityOperator, B::MPSTensor{4}, O2::LocalOperator{2, 2})::BilayerLeftTensor{2, 2}
	return @tensor tmp[i b; k l] := ((El.A[a b c d] * A.A[e i a g]) * B.A[c g h k]) * O2.A[d h e l]
end

function _pushright(El::BilayerLeftTensor{2, 2}, A::AdjointMPSTensor{4}, ::IdentityOperator, B::MPSTensor{4}, ::IdentityOperator)::BilayerLeftTensor{2, 2}
	return @tensor tmp[i b; k d] := (El.A[a b c d] * A.A[e i a g]) * B.A[c g e k]
end

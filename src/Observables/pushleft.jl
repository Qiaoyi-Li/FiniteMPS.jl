...
function _pushleft(Er::BilayerRightTensor{2, 2}, A::AdjointMPSTensor{4}, ::IdentityOperator, B::MPSTensor{4}, ::IdentityOperator)::BilayerRightTensor{2, 2}
	return @tensor tmp[a j; c l] := (B.A[j g e b] * Er.A[a b c d]) * A.A[e d l g]
end

function _pushleft(Er::BilayerRightTensor{2, 2}, A::AdjointMPSTensor{4}, ::IdentityOperator, B::MPSTensor{4}, O2::LocalOperator{2, 2})::BilayerRightTensor{2, 2}
	return @tensor tmp[i j; c l] := ((A.A[e d l g] * Er.A[a b c d]) * B.A[j g f b]) * O2.A[i f e a]
end

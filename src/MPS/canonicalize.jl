...
"""
function canonicalize!(obj::DenseMPS{L}, siL::Int64, siR::Int64; kwargs...) where L
     @assert 1 ≤ siL ≤ siR ≤ L
...
function canonicalize!(obj::DenseMPS, si::Vector{Int64}; kwargs...) 
     @assert length(si) == 2
     return canonicalize!(obj, si[1], si[2]; kwargs...)
end
canonicalize!(obj::DenseMPS, si::Int64; kwargs...)  = canonicalize!(obj, si, si; kwargs...) 
